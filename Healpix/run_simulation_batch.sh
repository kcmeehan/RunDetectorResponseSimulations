...
python lamp_CLLBC.py -healpix $nside $pixel -out /global/home/users/kmeehan/SCRATCH/SimulationOutput/Nside$(($nside))/cllbc_lamp/output_nside$(($nside))_lamp_cllbc_$(($pixel))_$((energy))keV -n $nEvents -E $energy -rad $source_rad -d $source_dist
