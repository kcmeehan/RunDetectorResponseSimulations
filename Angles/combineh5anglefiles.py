...
#source_energies=[59]
#source_energies=[662]
source_energies=[1332]
#source_energies=[59, 356, 662, 1332]
#phi=np.arange(0, 105, 15)
#phi=np.arange(0, 195, 15)
phi=np.arange(0, 360, 15)
nDet=4
detector='lamp_cllbc'
file_prefix='/global/home/users/kmeehan/SCRATCH/ProcessedOutput/RigSims/TrackSecondaries/processed_output_'+detector+'_angle_'+str(theta)+'_'
...
for energy in source_energies:
	...
	outfile='tracksecondaries_combined_output_'+detector+'_'+str(energy)+'keV_angles.h5'
